...
const Contact = () => {
  return (
    ...
    '>
       <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full pt-35 '>
         <div className='pb-8 '>
         ...
         <div className='flex justify-center items-center'>
            <form action="https://getform.io/f/bpjnjmrb" method='POST'  className='flex flex-col w-full md:w-1/2'>
                <input
                 type='text'
                 name='name'
